...
public class CalendarCard extends RelativeLayout {
	...
	private void init(Context ctx) {
		...
		layout.findViewById(R.id.cardTitle).setVisibility(View.GONE);
	...
	private void updateCells() {
		...
		Log.i("==", "firstDay="+firstDay+"lastDay="+lastDay);
		for (int i = firstDay; i < lastDay; i++) {
			...
			(mOnItemRender == null ? mOnItemRenderDefault : mOnItemRender).onRender(cell, (CardGridItem) cell.getTag(),2);
			counter++;
		}
