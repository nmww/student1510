  ...
  { 
    ...
    { 
      ...
      { 
         ...
         * bs=post&f=8&wd=HTTP+post
        */
        
        List <NameValuePair> params = new ArrayList <NameValuePair>(); 
        params.add(new BasicNameValuePair("bs", "post")); 
        params.add(new BasicNameValuePair("f", "8")); 
        params.add(new BasicNameValuePair("wd", "HTTP post")); 
        try 
        { 
          /*发出HTTP request*/
    ...
    { 
      ...
      { 
        ...
        /*声明网址字符串*/
        String uriAPI = "http://www.baidu.com/s?bs=post&f=8&wd=HTTP+post"; 
        /*建立HTTP Get联机*/
